...
//By considering the terms in the Fibonacci sequence whose values do not exceed four million, find the sum of the even-valued terms between the two arguments of the function.

function fiboAddEven(start, limit) {
	if (typeof start !== "number" || start === 0 || typeof limit !== "number")
